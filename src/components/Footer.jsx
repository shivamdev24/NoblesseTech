...
function Footer() {
  return (
    <footer className="bg-[#121212] py-10 px-5 text-white">
      <div className="md:w-[80%] md:mx-auto">
        <div className="flex flex-col lg:flex-row justify-between border-b">
          <div className="py-10">
            ...
            <div className="flex flex-col gap-6">
              <p className="text-lg md:text-xl font-bold">Subscribe</p>
              ...
              <form>
                <div className="flex gap-2">
                  <input
                    ...
                    className="p-3 w-56 sm:w-full border outline-none border-black"
                  />
                  <button className="p-3 px-6 bg-blue-500 text-white border border-blue-500">
                    Submit
                  </button>
                </div>
              </form>
        ...
        <div className="py-4">
          <p className="text-center text-xs sm:text-base text-white">
            Copyright © 2024 NoblesseTech All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
