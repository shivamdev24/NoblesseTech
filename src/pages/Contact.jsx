...
function Contact() {
  return (
    <>
      <div className="h-56 md:h-96 w-full py-32 bg-black text-white">
        <div className="md:w-[80%] md:mx-auto flex flex-col items-center justify-center px-5">
          <h1 className="text-4xl lg:text-6xl font-bold ">
            Contact NoblesseTech
          </h1>
          <p className="text-lg lg:text-xl">
            Get in touch with us for all your software development needs.
          </p>
        </div>
      </div>
      <section
        id="section2"
        className="h-full w-ful lg:mt-[6rem] bg-white text-black"
      >
        <div className="lg:w-[80%] lg:mx-auto w-full px-5 lg:px-0 ">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-[60%]  overflow-hidden w-full  h-full">
              <form>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-8 mt-5">
              <div className="bg-white flex flex-col gap-1 text-black border border-gray-200  hover:bg-gray-950 hover:text-white duration-500 w-full lg:w-[25rem] p-4 rounded">
                ...
                <p className="text-sm text-gray-400 ">
                  Whether you need support, have inquiries, or just want to
                  learn more about what we do, feel free to give us a call.
                </p>
